  ...
  def as_json(options={})
    {
      ...
      url: Catarse::Core::Engine.routes.url_helpers.project_by_slug_path(permalink, :locale => I18n.locale),
      full_uri: Catarse::Core::Engine.routes.url_helpers.project_by_slug_url(permalink, :locale => I18n.locale),
      expired: expired?,
