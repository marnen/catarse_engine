  ...
  describe "POST request_refund" do
    context "without user" do
      it "should redirect when don't have permission" do
        post :request_refund, { locale: 'pt', id: user.id, back_id: backer.id }
        backer.reload
    ...
    context "with user" do
      context "when current_user request to refund your backer" do
        ...
        it "success requested" do
          ...
          ActiveSupport::JSON.decode(subject.body)['status'].should == I18n.t('catarse.credits.index.refunded')
        end
        ...
        it "when user doesn't have a necessary value" do
          ...
          ActiveSupport::JSON.decode(subject.body)['status'].should == I18n.t('catarse.credits.refund.no_credits')
        end
        ...
        it "when backer cannot refunded" do
          ...
          ActiveSupport::JSON.decode(subject.body)['status'].should == I18n.t('catarse.credits.refund.refunded')
        end
        ...
        it "when backer already requested to refund" do
          ...
          ActiveSupport::JSON.decode(subject.body)['status'].should == I18n.t('catarse.credits.refund.requested_refund')
        end
      end
    end
  end
